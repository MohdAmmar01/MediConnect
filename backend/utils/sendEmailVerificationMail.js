...
const sendEmail = async (email, code) => {
  ...
  var mailOptions = {
    ...
    to: email,
    subject: `verify your email for MediConnect `,
    html: `
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <title>MediConnect - Email Verification</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            ...
            <ol class="instructions">
                ...
                <li>Complete the verification process to access your MediConnect account.</li>
            </ol>
        </div>
    </body>
    </html>
